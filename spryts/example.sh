...
# {{TEMPLATE_START}}
  ...
  ##############################################################################################
 ########  Example Family Functions - START  # {{TEMPLATE_FAMILY}}                     ########
##############################################################################################
#
# Example Title  # {{TEMPLATE_TITLE}}
# Shortcut - @example  # {{TEMPLATE_SHORTCUT}}
# Description - Example description of the thing and purpose  # {{TEMPLATE_DESCRIPTION}}
# Author - Seth Cottam  # {{TEMPLATE_AUTHOR}}
# Dependencies - colors, format, finder  # {{TEMPLATE_DEPENDENCIES}}
# Version - 4.0.1 # {{TEMPLATE_STATUS}}
# Status - Operational  # {{TEMPLATE_STATUS}}

# set -x  # Way too verbose, causes my stuff other problems
# setopt xtrace  # Way too verbose, causes my stuff other problems
# typeset -ft example
# typeset -ft _example_help
# set -E
# typeset -Ft _example_help
# typeset -Ft example
# TODO: MORE OPTIONS: https://stackoverflow.com/questions/64786/error-handling-in-bash


function example() {  # {{TEMPLATE_FAMILY_FUNCTION_NAME}}
    # Example parent function  # {{TEMPLATE_TITLE}}
...
EXAMPLE_SOURCE=${0:a}  # {{TEMPLATE_SOURCE_NAME}}

function _example_open() {  # {{TEMPLATE_CHILD_FUNCTION_NAME}}
...
function _example_help() {  # {{TEMPLATE_CHILD_FUNCTION_NAME}}
...
function _example_examples() {  # {{TEMPLATE_CHILD_FUNCTION_NAME}}
...
function _example_thing() {  # {{TEMPLATE_CHILD_FUNCTION_NAME}}
...
##############################################################################################
 ########  Example Family Functions - END  # {{TEMPLATE_FAMILY}}                       ########
  ##############################################################################################