...
function master_contoller_start() {
    ...
    # TODO: colors and format will probably need to loaded with source instead of load source
    ...
    if [[ $SPRY_MODE == "development" ]]; then
        ...
        format warning "Loading Spry CLI in DEVELOPMENT mode\n"
    ...
    local spryts=(${SPRY_CLI_ROOT_DIRECTORY}/spryts/*.sh)
