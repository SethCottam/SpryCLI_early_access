...
colors_help() {
    ...
    echo ""
    format info "${family} help"
    format casual "This tool is intended to operate as an example for other function sets"
...
colors_examples() {
    ...
    echo -e "${DEBUG1}${(C)family} help${RESET}  = ${CASUAL}${family} all${RESET}"
    echo -e "${DEBUG1}${(C)family} thing${RESET} = ${CASUAL}${family} thing${RESET}"
}
